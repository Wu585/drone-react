  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "custom-placeholder": "rgba(159, 159, 159, 1)",
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      backgroundImage: {
        ...
        'drone-aside': "url('@/assets/images/drone/bg-aside.png')",
        'drone-aside-2': "url('@/assets/images/drone/bg-aside-2.png')",
        'tsa-online': "url('@/assets/images/drone/bg-tsa-online.png')",
        'tsa-offline': "url('@/assets/images/drone/bg-tsa-offline.png')",
        ...
        'control-header': "url('@/assets/images/drone/bg-control-header.png')",
        ...
        'panel-item-active': "url('@/assets/images/drone/bg-panel-item-active.png')",
