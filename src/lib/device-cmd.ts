import {
  AirportStorage, AlarmModeEnum, BatteryStoreModeEnum,
  ChargeStateEnum,
  CoverStateEnum,
  DroneBatteryModeEnum,
  DroneBatteryStateEnum,
  LinkWorkModeEnum,
  PutterStateEnum, SupplementLightStateEnum
...
import {
  ...
  DeviceCmdItem,
  DeviceCmdStatusText
} from "@/types/device-cmd.ts";
import {DeviceInfoType} from "@/types/device.ts";
