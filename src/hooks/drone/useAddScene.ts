...
export const useAddScene = () => {
  const mapLayerList = [
    import.meta.env.VITE_ENV_NAME === "governmentAffairsNetwork" ?
      {
        url: "http://10.248.223.223:8090/iserver/services/map-ugcv5-FengXianJiChuDiTuDark231019/rest/maps/FengXianJiChuDiTuDark_231019",
        name: "矢量图"
      } :
      {
