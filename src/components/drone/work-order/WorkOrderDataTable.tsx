...
const createOrderSchema = z.object({
  ...
  street: z.string().min(1, "请输入涉及街道"),
  street_code: z.string().min(1, "请输入街道编号"),
  order_type: z.number({
...
const CreateOrderComponent = ({setOpen, currentOrder}: {
  ...
  const form = useForm<CreateOrderFormValues>({
    ...
    defaultValues: {
      ...
      street_code: currentOrder?.street_code || "",
      ...
      <Form {...form}>
        <form id="createOrderForm" onSubmit={form.handleSubmit(onSubmit)} className="grid grid-cols-2 gap-4">
          ...
          <FormField
            ...
            render={({field}) => (
              <FormItem className="grid grid-cols-4 gap-2 items-center">
                <FormLabel className="text-right">涉及街道</FormLabel>
                <FormControl>
                  <Input {...field} className="col-span-3 rounded-none h-[40px] bg-[#072E62]/[.7] border-[#43ABFF]"/>
                </FormControl>
                <FormMessage className="col-span-3 col-start-2"/>
          ...
          <FormField
            ...
            render={({field}) => (
              <FormItem className="grid grid-cols-4 gap-2 items-center">
                <FormLabel className="text-right">街道编号</FormLabel>
                <FormControl>
                  <Input {...field} className="col-span-3 rounded-none h-[40px] bg-[#072E62]/[.7] border-[#43ABFF]"/>
                </FormControl>
                <FormMessage className="col-span-3 col-start-2"/>
          ...
          <FormField
            ...
            render={({field}) => (
              <FormItem className="grid grid-cols-4 gap-2 items-center">
                <FormLabel className="text-right">发生地址</FormLabel>
                <FormControl>
                  <Input {...field} className="col-span-3 rounded-none h-[40px] bg-[#072E62]/[.7] border-[#43ABFF]"/>
                </FormControl>
                <FormMessage className="col-span-3 col-start-2"/>
          ...
          <FormField
            ...
            render={({field}) => (
              <FormItem className="grid grid-cols-4 gap-2 items-center">
                <FormLabel className="text-right">经度</FormLabel>
                <FormControl>
                  <Input {...field} type="number" step="0.000001"
                         className="col-span-3 rounded-none h-[40px] bg-[#072E62]/[.7] border-[#43ABFF]"/>
                </FormControl>
                <FormMessage className="col-span-3 col-start-2"/>
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({field}) => (
              <FormItem className="grid grid-cols-4 gap-2 items-center">
                <FormLabel className="text-right">纬度</FormLabel>
                <FormControl>
                  <Input {...field} type="number" step="0.000001"
                         className="col-span-3 rounded-none h-[40px] bg-[#072E62]/[.7] border-[#43ABFF]"/>
                </FormControl>
          ...
          <FormField
            ...
            render={({field}) => (
              <FormItem className="grid grid-cols-4 gap-2 items-center">
                <FormLabel className="text-right">问题描述</FormLabel>
                <FormControl>
                  <Textarea
                    {...field}
